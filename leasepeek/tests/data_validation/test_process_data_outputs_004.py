...
class ProcessDataViewValuesTest(APITestCase):
    ...
    def test_data_output(self):
        ...
        self.assertEqual(response_data['location']['buildingName'], os.environ.get('04_TEST_FILE_LOCATION'))
        ...
        self.assertEqual(response_data['vacancy']['Occupied']['count'], 259)
        self.assertEqual(response_data['vacancy']['Model']['count'], 1)
        self.assertEqual(response_data['vacancy']['Vacant']['count'], 64)
        self.assertEqual(response_data['vacancy']['Applicant']['count'], 16)
        self.assertEqual(response_data['vacancy']['Pending renewal']['count'], 3)
        ...
        self.assertEqual(response_data['floorplans'][floorplan07]['avgRent'], 1720.52)
        self.assertEqual(response_data['floorplans'][floorplan07]['sumRent'], 115275)
